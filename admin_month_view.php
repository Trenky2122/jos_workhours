...
$done_days = $service->GetDoneWorkerWorkDays($selected_worker_id, $month, $year);
$total_time = array();
?>
...
<div class="row">
    <div class="col-12">
        <table id="example" class="export_table">
            ...
            <tr>
                <td colspan="3" class="last export_table_cell">Zamestnanec: <?= $service->GetWorkerNameWithId($selected_worker_id) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="sum export_table_cell" colspan="2">
                    <?php
                    $projectData = $service->GetProjectDataForWorker($selected_worker_id, $list_of_dates[0][2], end($list_of_dates)[2]);
...
<div class="row noprint mt-1 mb-1">
    ...
    <div class="col-1">
        <a class="btn btn-primary" href="month_view_80.php?id=<?= $selected_worker_id ?>&m=<?= $year."-".$month ?>">80 hodinová
            verzia</a>
    </div>
    <?php
    $rework = false;
